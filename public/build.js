...
/******/ 	var hotCurrentHash = "1b8dbbe8cb5bddb29ca0"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Scheduler = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppointmentsCollection = __webpack_require__(2);
	
	var _AppointmentsCollection2 = _interopRequireDefault(_AppointmentsCollection);
	...
	var Scheduler = function () {
	    function Scheduler(options) {
	        ...
	        this.config = _Config2.default.set(options).getInstance();
	
	        this.appointments = _AppointmentsCollection2.default.getInstance();
	    ...
	    _createClass(Scheduler, [{
	        ...
	        value: function render() {
	            ...
	            container.appendChild(this.calendar.el);
	            ...
	            _underscore2.default.defer(function () {
	                return _Mediator2.default.publish('Appointment.add', appointments);
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Appointment = __webpack_require__(4);
	...
	var AppointmentsCollection = function () {
	  function AppointmentsCollection() {
	    _classCallCheck(this, AppointmentsCollection);
	
	    this.appointments = [];
	
	    _Mediator2.default.subscribe('AppointmentsCollection.render', this.render, this);
	    _Mediator2.default.subscribe('Appointment.add', this.add, this);
	  }
	
	  _createClass(AppointmentsCollection, [{
	    key: 'render',
	    value: function render() {
	      _underscore2.default.invoke(this.appointments, 'render');
	    }
	  }, {
	    key: 'add',
	    value: function add(appointments) {
	      this.appointments = this.appointments.concat([].concat(appointments).map(this.createAppointment, this));
	    }
	  }, {
	    key: 'createAppointment',
	    value: function createAppointment(appointment) {
	      var instance = new _Appointment2.default(appointment);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Appointment = function () {
	  function Appointment(params) {
	    ...
	    this.config = _Config2.default.getInstance().calendar;
	    this.ctx = _Canvas2.default.getCtx('calendar');
	    ...
	    _Mediator2.default.subscribe('Calendar.mousedown', this.onMousedown, this);
	    _Mediator2.default.subscribe('Calendar.mouseup', this.onMouseup, this);
	  }
	  ...
	  _createClass(Appointment, [{
	    ...
	    key: 'moveAppointment',
	    value: function moveAppointment(event) {
	      ...
	      _Mediator2.default.publish('Calendar.renderWeek');
	      _Mediator2.default.publish('AppointmentsCollection.render');
	    }
	  }, {
	    key: 'onMousedown',
	    value: function onMousedown(e) {
	      if (this.isAppointmentSelected({ x: e.offsetX, y: e.offsetY })) {
	        ...
	        setTimeout(function () {
	          if (this.isMoving) {
	            _Mediator2.default.publish('Appointment.moveStart', this.onMouseMove);
	            this.hasMoved = true;
	          }
	    ...
	    key: 'onMouseup',
	    value: function onMouseup(coords) {
	      if (this.hasMoved) {
	        _Mediator2.default.publish('Appointment.moveStop', this.onMouseMove);
	    ...
	    key: 'getMoveHandler',
	    value: function getMoveHandler() {
	      return _underscore2.default.throttle(this.moveAppointment.bind(this), 1000 / 60);
	    }
	  }, {
	    key: 'placeAppointment',
	    value: function placeAppointment(coords) {
	      this.ctx.clearRect(this.position.x, this.position.y, this.position.width, this.position.height);
	      this.changeAppointmentTime(coords);
	      this.calculatePosition();
	    }
	  }, {
	    key: 'changeAppointmentTime',
	    value: function changeAppointmentTime(coords) {
	      var time = _Util2.default.getTime(coords.x, coords.y);
	    ...
	    key: 'isAppointmentSelected',
	    value: function isAppointmentSelected(coords) {
	      return this.position.y + this.position.height > coords.y && this.position.x + this.position.width > coords.x && this.position.x < coords.x && this.position.y < coords.y;
	    }
	  }, {
...
/***/ function(module, exports) {
	...
	var Mediator = function () {
	  ...
	  _createClass(Mediator, null, [{
	    key: "subscribe",
	    value: function subscribe(channel, clb, ctx) {
	      if (!channels[channel]) {
	        channels[channel] = [];
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Config = function () {
	  ...
	  _createClass(Config, null, [{
	    key: 'getInstance',
	    value: function getInstance() {
	      return _underscore2.default.clone(this.config);
	    }
	  }, {
	    key: 'set',
	    ...
	    key: 'calculateAdditionalParams',
	    value: function calculateAdditionalParams(config) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Util = function () {
	  ...
	  _createClass(Util, null, [{
	    key: 'getTime',
	    value: function getTime(x, y) {
	      var config = _Config2.default.getInstance().calendar,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MouseEvents = function () {
	  function MouseEvents() {
	    ...
	    this.config = _Config2.default.getInstance();
	    this.attachEvents();
	
	    _Mediator2.default.subscribe('Appointment.moveStop', this.onMouseStop);
	    _Mediator2.default.subscribe('Appointment.moveStart', this.onMouseMove);
	  }
	
	  _createClass(MouseEvents, [{
	    key: 'attachEvents',
	    value: function attachEvents() {
	      _Canvas2.default.get('calendar').addEventListener('mousedown', this.onMousedown, false);
	      _Canvas2.default.get('calendar').addEventListener('dblclick', this.onDblclick, false);
	      _Canvas2.default.get('calendar').addEventListener('mouseup', this.onMouseup, false);
	    }
	  }, {
	    key: 'onMouseMove',
	    value: function onMouseMove(clb) {
	      _Canvas2.default.get('calendar').addEventListener('mousemove', clb, false);
	    }
	  }, {
	    key: 'onMouseStop',
	    value: function onMouseStop(clb) {
	      _Canvas2.default.get('calendar').removeEventListener('mousemove', clb);
	    }
	  }, {
	    key: 'detachEvents',
	    value: function detachEvents() {
	      _Canvas2.default.get('calendar').removeEventListener('mousedown', this.onMousedown);
	      _Canvas2.default.get('calendar').removeEventListener('dblclick', this.onDblclick);
	      _Canvas2.default.get('calendar').removeEventListener('mouseup', this.onMouseup);
	    }
	  }, {
	    key: 'onDblclick',
	    value: function onDblclick(e) {
	      _Mediator2.default.publish('Calendar.dblclick', e);
	    }
	  }, {
	    key: 'onMousedown',
	    value: function onMousedown(e) {
	      _Mediator2.default.publish('Calendar.mousedown', e);
	    }
	  }, {
	    key: 'onMouseup',
	    value: function onMouseup(e) {
	      _Mediator2.default.publish('Calendar.mouseup', e);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WeekView = __webpack_require__(11);
	...
	var Calendar = function () {
	  function Calendar() {
	    ...
	    this.rightSidebar = new _Sidebar2.default('right');
	    this.leftSidebar = new _Sidebar2.default('left');
	  ...
	  _createClass(Calendar, [{
	    ...
	    value: function render() {
	      // render left sidebar
	      this.el.appendChild(this.leftSidebar.render().canvas);
	
	      // render calendar greed
	      for (var week = 0; week < this.config.calendar.week.weeks; ++week) {
	        new _WeekView2.default(week).render();
	      }
	      ...
	      this.el.appendChild(this.rightSidebar.render().canvas);
	
	      return this;
	    }
	  }, {
	    key: 'listenForRerender',
	    value: function listenForRerender() {
	      _Mediator2.default.subscribe('Calendar.renderWeek', this.renderWeek);
	    }
	  }, {
	    key: 'renderWeek',
	    value: function renderWeek() {
	      new _WeekView2.default(0).render();
	    }
	  }, {
	    key: 'createCanvas',
	    value: function createCanvas() {
	      this.canvas = _Canvas2.default.create('calendar', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DayView = __webpack_require__(12);
	...
	var WeekView = function () {
	  function WeekView() {
	    ...
	    this.config = _Config2.default.getInstance().calendar;
	    this.ctx = _Canvas2.default.getCtx('calendar');
	    this.dayView = new _DayView2.default();
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HourView = __webpack_require__(13);
	...
	var DayView = function () {
	  function DayView() {
	    ...
	    this.config = _Config2.default.getInstance().calendar;
	    this.ctx = _Canvas2.default.getCtx('calendar');
	    this.hourView = new _HourView2.default();
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MinuteView = __webpack_require__(14);
	...
	var HourView = function () {
	  function HourView(hour) {
	    _classCallCheck(this, HourView);
	
	    this.config = _Config2.default.getInstance().calendar;
	    this.ctx = _Canvas2.default.getCtx('calendar');
	    this.minuteView = new _MinuteView2.default();
	  }
	...
	var MinuteView = function () {
	  ...
	  _createClass(MinuteView, [{
	    ...
	    value: function render(minute) {
	      ...
	      this.ctx.strokeRect(0.5, 0.5, this.config.minute.width, this.config.minute.height);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sidebar = function () {
	  ...
	  _createClass(Sidebar, [{
	    ...
	    key: 'renderMinutes',
	    value: function renderMinutes(hour) {
	      ...
	      for (var minute = 1; minute <= this.config.minute.minutes; minute++) {
	        ...
	        if (minute !== this.config.minute.minutes) {
	          this.renderText(60 / this.config.minute.minutes * minute % 60, this.config.sidebar.width / 2, hour * this.config.hour.height + minute * this.config.minute.height + 15);
	        }
	      }
	    ...
	    key: 'renderText',
	    value: function renderText(text, x, y) {
	    ...
	    key: 'createCanvas',
	    value: function createCanvas() {
	      this.canvas = _Canvas2.default.create('sidebar.' + this.side, {
	        height: this.config.hour.hours * this.config.hour.height,
	        width: this.config.sidebar.width
	      });
	
	      this.ctx = _Canvas2.default.getCtx('sidebar.' + this.side);
